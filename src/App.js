    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={<MainLayout />}>
          ...
          <Route path="chart1" element={<ChartDash />} />
          ...
          <Route path="crud2-form" element={<CRUD2Form />} /> {/* Updated route for CRUD2Form */}
           {/* Updated route for CRUD2Form */}          Route
        </Route>
      </Routes>
    </Router>
  );
